...
const SudokuPuzzle = () => {
    ...
    const validatePuzzle = () => {
        ...
        setValidationResult(isPuzzleValid ? 'Başarılı' : 'Başarısız');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <Button title="Kontrol" onPress={validatePuzzle} />
                <Button title="Bitir" onPress={solvePuzzle} />
                <Button title="Yeniden" onPress={resetPuzzle} />
            </View>
            {validationResult !== '' && (
                <Text style={validationResult === 'Başarılı' ? 
